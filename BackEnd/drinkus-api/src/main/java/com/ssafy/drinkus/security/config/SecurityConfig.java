...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/users/join", "/users/login", "/users/join/id", "/users/id", "/users/pw", "/email/sendCheckMail").permitAll()
                .antMatchers(HttpMethod.PATCH, "/email/confirm").permitAll()
