...
const EditCalendar2 = ({ calendarId, close, setModalType, successHandler }) => {
  ...
  return (
    <>
      <CreateCalendarBlock>
        ...
        <InputBlock>
          <CreateButton onClick={onCalendarInfoSubmit}>수정하기</CreateButton>
        </InputBlock>
      </CreateCalendarBlock>
    </>
  );
