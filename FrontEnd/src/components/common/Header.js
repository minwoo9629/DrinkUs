  ...
  return (
    ...
    >
      <HeaderMenu width={100} justify={"space-between"}>
        <li>
          <NavLink to="/" className={HeaderStatus ? "a" : "a light"}>
            DrinkUs
          </NavLink>
        </li>
        <li>
          <NavLink to={"/live"} className={HeaderStatus ? "a" : "a light"}>
            술Live
          </NavLink>
        </li>
        <li>
          <NavLink to={"/community"} className={HeaderStatus ? "a" : "a light"}>
            커뮤니티
          </NavLink>
        </li>
        {user.isLogin ? (
          <>
            <li>
              <NavLink
                to={"/users/{user_no}"}
                className={HeaderStatus ? "a" : "a light"}
              >
            ...
            <li>
              ...
              <NavLink to={"/alarm"} className={HeaderStatus ? "a" : "a light"}>
          ...
          <>
            <li>
              <NavLink to={"/login"} className={HeaderStatus ? "a" : "a light"}>
                로그인
              </NavLink>
            </li>
            <li>
              <NavLink to={"/join"} className={HeaderStatus ? "a" : "a light"}>
                회원가입
              </NavLink>
            </li>
          </>
